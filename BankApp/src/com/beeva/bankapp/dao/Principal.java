            ...
            do {
                ...
                switch (opc) {
                    case 1:
                        ...
                        ape = lector.nextLine();
                        lector = new Scanner(System.in);
                        System.out.println("Tipo de Cuenta: 1. Ahorros 2. Cheques");
                        tipoCuenta = lector.nextInt();
                        lector = new Scanner(System.in);
                        System.out.println("Deposito Inicial:");
                        dinero = lector.nextDouble();
                        Cuenta cue = new Cuenta(tipoCuenta, dinero);
                        b.addCliente(nom, ape, cue, tipoCuenta);
                    ...
                    case 4:
                        for (int i = 0; i < b.getClientes(); i++) {
                            System.out.println(b.getCliente(i).nombre+" $"+b.getCliente(i).cuenta.getBalance()+" Tipo "+b.getCliente(i).cuenta.getTipoCuenta());
                        }
                        break;
                    case 5:
                    	lector = new Scanner(System.in);
                        ...
                        x = lector.nextInt();
                        if (b.getCliente(x).nombre != "") {
                            System.out.println("Cliente: " + b.getCliente(x).nombre + " con un balance de: " + b.getCliente(x).cuenta.getBalance());
                        } else {
